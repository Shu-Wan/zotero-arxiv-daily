...
<br><br>
<div>
Generated by <a href="https://github.com/Shu-Wan/zotero-arxiv-daily/" target="_blank">zotero-arxiv-daily</a>.
...
def render_email(papers:list[ArxivPaper]):
    ...
    for p in tqdm(papers,desc='Rendering Email'):
        ...
        parts.append(get_block_html(p.title, authors,rate,p.arxiv_id ,p.tldr, pdf_url, p.code_url))
        time.sleep(10)
...
def send_email(sender:str, receiver:str, password:str,smtp_server:str,smtp_port:int, html:str,):
    ...
    msg['From'] = _format_addr("Shu's Paper Bot <%s>" % sender)
    msg['To'] = _format_addr('You <%s>' % receiver)
    today = datetime.datetime.now().strftime('%Y/%m/%d')
    msg['Subject'] = Header(f'Daily arXiv paper digest of {today}', 'utf-8').encode()
